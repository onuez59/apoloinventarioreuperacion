...
class ClientForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'cedula': forms.TextInput(attrs={'placeholder': 'Ingrese un número de cedula'}),
            'correo': forms.TextInput(attrs={'placeholder': 'Ingrese una dirección'})
        }
...
class SaleForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'serial_inventario': forms.TextInput(attrs={
                'readonly': True,
                'class': 'form-control',
            })
        }
...
class CompanyForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'name': forms.TextInput(attrs={'placeholder': 'Ingrese un nombre'}),
            'rif': forms.TextInput(attrs={'placeholder': 'Ingrese un ruc'}),
            'correo': forms.TextInput(attrs={'placeholder': 'Ingrese una dirección'}),
